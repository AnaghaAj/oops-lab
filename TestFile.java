...
class TestFile
{
	...
	{
		File f1=new File("c://javaprograms");
		if(f1.isDirectory())
		{
			...
			{
				File f2=new File("c://javaprograms"+"//"+s[i]);
				if(f2.isDirectory())
				{
	   ...
	   {
		   System.out.println("c://javaprograms" + " is not a directory");
	   }
...
boolean f=false;
	...
	{
		File f2=new File("c://javaprograms"+"//"+filelist[i]);
